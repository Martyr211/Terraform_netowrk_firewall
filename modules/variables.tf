...
variable "subnet_mapping" {
  type        = list(string)
  description = "Subnets list. Each subnet must belong to a different Availability Zone in the VPC. AWS Network Firewall creates a firewall endpoint in each subnet."
}
...
# Managed Stateful rules
variable "stateful_managed_rule_groups_arn" {
  type = list(any)
  description = "Map of managed stateful groups"
}
